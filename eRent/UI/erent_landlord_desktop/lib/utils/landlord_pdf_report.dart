...
class LandlordPdfReport {
  static const _primary = PdfColor.fromInt(0xFFFFB84D);
  ...
  static const _lightBg = PdfColor.fromInt(0xFFFFFBF5);
  static const _white = PdfColors.white;
  static const _tableBorder = PdfColor.fromInt(0xFFE5E7EB);
  static const _headerBg = PdfColor.fromInt(0xFF92400E);

  static Future<void> generateAndPrint(LandlordAnalytics analytics, {String? landlordName}) async {
    ...
    final name = landlordName ?? 'Landlord';

    pdf.addPage(
      pw.MultiPage(
        pageFormat: PdfPageFormat.a4,
        margin: const pw.EdgeInsets.all(40),
        header: (context) => _buildHeader(name, dateStr),
    ...
    await Printing.layoutPdf(
      ...
      name: 'eRent_Landlord_Report_${DateFormat('yyyyMMdd_HHmm').format(now)}',
    );
  }
  ...
  static pw.Widget _buildFooter(pw.Context context) {
    return pw.Container(
      ...
      child: pw.Row(
        ...
        children: [
          pw.Text(
            'eRent Platform - Landlord Report - Confidential',
  ...
  static pw.Widget _buildExecutiveSummary(LandlordAnalytics a) {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
  ...
  static pw.Widget _buildRevenueSection(LandlordAnalytics a) {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        ...
        pw.Row(
          crossAxisAlignment: pw.CrossAxisAlignment.start,
          children: [
            pw.Expanded(child: _buildMiniStat('Total Revenue', _eur(a.totalRevenue))),
            pw.SizedBox(width: 8),
            pw.Expanded(child: _buildMiniStat('Monthly Revenue', _eur(a.monthlyRevenue))),
            pw.SizedBox(width: 8),
            pw.Expanded(child: _buildMiniStat('Avg Rent Price', _eur(a.averageRentPrice))),
          ],
        ),
        pw.SizedBox(height: 12),
        ...
        if (a.revenueByCity.isNotEmpty) ...[
          _subSectionTitle('Revenue by City'),
          pw.SizedBox(height: 6),
          _buildStyledTable(
  ...
  static pw.Widget _buildRentalOperationsSection(LandlordAnalytics a) {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
  ...
  static List<List<String>> _rentStatusRows(LandlordAnalytics a) {
  ...
  static pw.Widget _buildPropertyPortfolioSection(LandlordAnalytics a) {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        ...
        if (a.propertiesByCity.isNotEmpty) ...[
          _subSectionTitle('Properties by City'),
          pw.SizedBox(height: 6),
          _buildStyledTable(
  ...
  static pw.Widget _buildReviewsSection(LandlordAnalytics a) {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
  ...
  static List<List<String>> _ratingRows(LandlordAnalytics a) {
  ...
  static pw.Widget _buildRatingBar(LandlordAnalytics a) {
    final total = a.totalReviews > 0 ? a.totalReviews : 1;
    final segments = [
  ...
  static pw.Widget _buildMonthlyTrendsSection(LandlordAnalytics a) {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
  ...
  static pw.Widget _subSectionTitle(String title) {
    return pw.Container(
      ...
      decoration: pw.BoxDecoration(
        ...
        border: pw.Border.all(color: PdfColor.fromInt(0xFFFED7AA), width: 0.5),
      ),
      child: pw.Text(
        title,
        style: pw.TextStyle(
